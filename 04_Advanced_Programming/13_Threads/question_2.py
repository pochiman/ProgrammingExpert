...
# Start, stop and join the existing functions as threads in the program such lst = [1, 4, 3, 5, 3] at the 
# end of the program.  You must use multithreading, create at least three threads and use both functions.
