...
# Your generator should not store this string, it should generate the next element in the sequence each time 
# its next method is called.

# You should create this generator in both a functional and class based way.  Your functional generator should 
# be named generate_string and your class based generator (a.k.a iterator) should be named GenerateString.
